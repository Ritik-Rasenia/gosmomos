...
@section('title', 'Edit CMS Page — GOS MOMO')
...
<div class="mb-4">
    ...
    <h4 class="fw-bold">Edit Page Content</h4>
    <p class="text-muted">Modify page body, publishing status, and metadata details.</p>
</div>
    ...
    <form action="{{ route('admin.pages.update', $page->id) }}" method="POST">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-8">
                ...
                <input type="text" name="title" class="form-control rounded-3" value="{{ old('title', $page->title) }}" required>
                @error('title') <span class="text-danger small">{{ $message }}</span> @enderror
            </div>

            <div class="col-md-4 d-flex align-items-end">
                <div class="form-check p-3 border rounded-3 bg-light w-100 mb-1">
                    <input class="form-check-input ms-0 me-2" type="checkbox" name="is_active" value="1" id="is_active" {{ old('is_active', $page->is_active) ? 'checked' : '' }}>
            ...
            <div class="col-12">
                ...
                <!-- Editor Container populated with existing content -->
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="meta_title" class="form-control rounded-3" value="{{ old('meta_title', $page->meta_title) }}">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="meta_keywords" class="form-control rounded-3" value="{{ old('meta_keywords', $page->meta_keywords) }}">
            ...
            <div class="col-12 mt-4">
                <button type="submit" class="btn btn-orange rounded-pill px-5">Save Changes</button>
            </div>
        </div>
    </form>
</div>
